...
function PociskiStatku({polozeniePocisku}){
    ...
    `right-72 mr-28`, `right-72 mr-5`, `right-56 mr-1`, `right-44 mr-1`, `right-28`, 
    `right-12 mr-2`, `right-3`];
    ...
    `cna89ghxzv`, `b79atjhx`, `hc9astw`, `busgnbvcn`];//styl={pocisk} polozenie={polozeniePocisku[index]} key={kluczePociskow[index]
    return (
        <>
...
export default memo(PociskiStatku);